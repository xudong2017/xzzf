...
public class AccountController extends AbstractController {
	...
	public LayerJsonReturn findAccountList(@RequestParam int page,@RequestParam int limit, @RequestParam(required=false) String searchValue, HttpSession httpSession) {
		return accountService.findAccountList(page,limit, searchValue, acctName(httpSession));
	}
