...
public class RoleServiceImpl implements RoleService {
	...
	public JSONReturn findRoleList(int page, int limit, String searchVal, String acctName) {
		// TODO Auto-generated method stub
		List<RoleListDto> dtoList = roleDao.findRoleList(page,limit, searchVal);
	...
	public LayerJsonReturn findRoleList2(int page,int limit, String searchVal, String acctName) {
		// TODO Auto-generated method stub
		List<RoleListDto> dtoList = roleDao.findRoleList(page,limit, searchVal);
		if (CollectionUtils.isEmpty(dtoList))
		...
		for (RoleListDto dto : dtoList)
			dto.setTime(DateTimeUtil.conversionTime(dto.getData(), TimeFormatConstant.YYYY_MM_DD));
		int count = roleDao.findRoleCount(searchVal);
